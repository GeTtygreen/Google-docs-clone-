...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center bg-white px-4 py-2 shadow-md">
      ...
      <div className=" mx-5 flex flex-grow items-center rounded-lg bg-gray-100 px-5 py-2 text-gray-600 md:mx-20 focus-within:text-gray-600 focus-within:shadow-md">
